...
<body class="min-h-full">
    <nav class="bg-transparent">
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <?php if ($_SESSION["role"] === "student") {?>
                <a href="/" class="block rounded-md bg-[#F9A826] text-white px-3 py-2 text-base font-medium" aria-current="page">Home</a>
            <?php } else { ?>
                <a href="/professor/home" class="block rounded-md bg-[#F9A826] text-white px-3 py-2 text-base font-medium" aria-current="page">Home</a>
            <?php } ?>
            <?php if ($_SESSION["role"] !== "student") {?>
                <a href="/dashboard" class="block rounded-md text-[#F9A826] hover:bg-[#2E2A47] hover:text-white px-3 py-2 text-base font-medium">Dashboard</a>
            <?php } ?>
                <a href="/courses" class="block rounded-md text-[#F9A826] hover:bg-[ #2E2A47] hover:text-white px-3 py-2 text-base font-medium">Courses</a>
            <?php if ($_SESSION["role"] === "student") {?>
                <a href="/diagonalley" class="block rounded-md text-[#F9A826] hover:bg-[#2E2A47] hover:text-white px-3 py-2 text-base font-medium">Diagon Alley</a>
            <?php } ?>
                <a href="/leaderboard" class="block rounded-md text-[#F9A826] hover:bg-[#2E2A47] hover:text-white px-3 py-2 text-base font-medium">Leader Board</a>
            </div>
        </div>
    </nav>
</div>
